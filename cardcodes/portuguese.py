...
def get_cards_por(all_words, conn):
  ...
  for word in all_words:
    ...
    if db_word:
      ...
      # #Get soup
      # dictionary_data = requests.get(f"https://www.dicio.com.br/{word}/")
      # soup = BeautifulSoup(dictionary_data.text, 'html.parser')
      #
      # sentences = soup.select('div.frase')
      #
      # f_sentence = ""
      # e_sentence = ""
